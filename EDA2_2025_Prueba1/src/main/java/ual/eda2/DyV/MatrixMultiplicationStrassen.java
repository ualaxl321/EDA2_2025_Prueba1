...
public class MatrixMultiplicationStrassen {
	...
	public static int[][] multiplyMatrix(int[][] A, int[][] B) {
		...
		// Matrix
			...
			// M2 = (A2 + A4) × (B3 + B4)
			int[][] M2 = multiplyMatrix(add(A21, A22), B11);
           
			// M3 = (A1 − A4) × (B1 + A4)
			int[][] M3 = multiplyMatrix(A11, sub(B12, B22));
           
			// M4 = A1 × (B2 − B4)
			int[][] M4 = multiplyMatrix(A22, sub(B21, B11));
           
			// M5 = (A3 + A4) × (B1)
			int[][] M5 = multiplyMatrix(add(A11, A12), B22);
           
			// M6 = (A1 + A2) × (B4)
			int[][] M6 = multiplyMatrix(sub(A21, A11), add(B11, B12));
           
			// M7 = A4 × (B3 − B1)
			int[][] M7 = multiplyMatrix(sub(A12, A22), add(B21, B22));
